...
- [5. The 8-Step ADDF Lifecycle](#5-the-8-step-addf-lifecycle)
...
- [6. How the Modes, Scale Model, and 8 Steps Fit Together](#6-how-the-modes-scale-model-and-8-steps-fit-together)
...
# 6. How the Modes, Scale Model, and 8 Steps Fit Together
...
## 6.1 Mode Mapping to the Lifecycle
