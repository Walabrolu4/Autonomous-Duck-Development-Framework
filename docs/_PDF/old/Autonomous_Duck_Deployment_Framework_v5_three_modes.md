...
ADDF uses only three modes.

This is intentional.

Earlier versions of the framework separated Research, Design / Feasibility, Architect, Builder, and Audit into separate modes. That created confusion because those modes started to look like another lifecycle.

Version 5 simplifies the model.
...
This mode replaces the earlier idea of separate Architect Mode, Design / Feasibility Mode, Audit Mode, and Review Mode.
...
This is where Design Mode replaces the older “Architect Mode” label.
